...
const GetAsObtainLesson1 = () => {
 ...
 <Layout>
      <header>
        <h2>Use Get Instead To Obtain Something</h2>
      </header>
       <Spacer size="medium" />
      <MainColumn>
        ...
        <section>
          <h3>Use 'To Get' To Obtain Something</h3>
          <h4>Use get instead of buy</h4>
          <ul>
        ...
        <section>
          <h3>Contract (obtain a service)</h3>
          <ul>
  ...
  export default GetAsObtainLesson1;
