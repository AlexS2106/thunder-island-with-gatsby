...
////**  COMPONENT **////
const PoemTemplate = ( { data, pageContext } ) => {
    ...
    <Layout>
      ...
      <MainColumn>
        <article>
          ...
          { generateTags }
            <p className="withSideBorder addBorderPadding" style={ {maxInlineSize: "fit-content", margin: "auto" } }>{ excerpt }</p>
          </header>
          { contentBody }
          <p>{ associated }</p>
