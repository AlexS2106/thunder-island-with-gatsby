...
import {
  singleArrowRight, singleArrowLeft, doubleArrowRight, doubleArrowLeft } from "../../utilities/iconFunctions";
...
const Arrow = ( { type, direction, color } ) => {
  ...
  return (
    <span className={ generateClassName(color) }>{ generateArrow(type, direction) }</span>
  );
}
