...
#### Method
  ...
  - **Step 2**
    - Melt the lard on high heat in a medium-sized frying pan. (I use number 8.)
  ...
  - **Step 4**
    ...
    - Add the beef stock to the pan and scrape the bottom of the pan to get all the brown bits up.
