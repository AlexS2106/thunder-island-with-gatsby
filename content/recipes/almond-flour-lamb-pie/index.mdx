...
#### Method
  ...
  - **Step 3**
    - Melt the ghee on high heat in a medium-sized frying pan. (I use number 9.)
  ...
  - **Step 8**
    ...
    - Transfer the pastry pieces across to cover the lamb until you use up all the pastry and the pie is completely covered.
  - **Step 9**
